...
export function ModuleDeleteDialog({ id, show, onHide }) {
  ...
  const { isLoading } = useSelector(
    (state) => ({
      isLoading: state.AvailablePaymentMethods.actionsLoading,
    }) /* change module */,
    shallowEqual
  );
  ...
  return (
    ...
    >
      ...
      <Modal.Body>
        {!isLoading && (
          <span>
            Are you sure to permanently delete this Payment Methode?
          </span>
        )}
        {isLoading && <span> Payment Methode is deleting...</span>}
      </Modal.Body>
