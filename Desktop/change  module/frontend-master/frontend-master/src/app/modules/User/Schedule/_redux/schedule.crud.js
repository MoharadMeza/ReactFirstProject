...
/* change module */
export const MODULE_URL = `${process.env.REACT_APP_API_URL}/schedule`;
...
export function getAllRecords() {
  return axios.get(`${MODULE_URL}/user`);
}
...
export function findRecords(queryParams) {
  ...
  return axios.get(`${MODULE_URL}/user`, { params: transformQueryParamsData });
}
